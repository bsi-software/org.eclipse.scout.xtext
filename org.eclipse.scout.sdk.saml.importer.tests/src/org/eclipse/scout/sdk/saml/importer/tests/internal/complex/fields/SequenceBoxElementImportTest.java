...
/**
 * <h3>{@link SequenceBoxElementImportTest}</h3>
 * 
 * @author mvi
 * @since 3.9.0 05.02.2013
 */
public class SequenceBoxElementImportTest extends AbstractSamlFieldImporterTest implements IComplexFieldTestConstants {

  private final static String[] LOCATION = new String[]{"SequenceTest"};
  ...
  @Test
  public void testAutoCheckFromToAttribute() throws Exception {
    // this attribute is always set to false
    testBoolConfigMethod(getField(FORM_NAME, LOCATION), "getConfiguredAutoCheckFromTo", false);
  }
  ...
  public void testWidthPixelsAttribute() throws Exception {
    testIntConfigMethod(getField(FORM_NAME, LOCATION), "getConfiguredWidthInPixel", 600);
  }
}
