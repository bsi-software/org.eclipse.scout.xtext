...
/**
 * <h3>{@link ListElementImportTest}</h3>
 * 
 * @author mvi
 * @since 3.9.0 05.02.2013
 */
public class ListElementImportTest extends AbstractSamlFieldImporterTest implements IComplexFieldTestConstants {

  private final static String[] LOCATION1 = new String[]{"GroupTest", "TestList1"};
  private final static String[] LOCATION2 = new String[]{"GroupTest", "TestTabBox", "TestTab1", "TestList2"};
  ...
  public void testWidthPixelsAttribute() throws Exception {
    testIntConfigMethod(getField(FORM_NAME, LOCATION2), "getConfiguredWidthInPixel", 100);
  }
