	...
	def void testComplexFormsOverFiles() {
		...
		form ComplexFieldTest {
		  sequence SequenceTest text=trans.text1 enabled=false visible=false label_visible=false width=2 width_pixels=600 {
			...
			label LabelTest1 text=trans.text1 enabled=true visible=true wrap_text=false
			label LabelTest2 text=trans.text2 enabled=false visible=false label_visible=false mandatory=true master=LabelTest1 width=2 width_pixels=200 horizontal_align=center wrap_text=true
