		...
		if (nameMappings == null) {
			nameMappings = new HashMap<AbstractElement, String>() {
				private static final long serialVersionUID = 1L;
				{
					...
					put(grammarAccess.getFormFieldPropertiesAccess().getGroup(), "rule__FormFieldProperties__Group__0");
					put(grammarAccess.getFormFieldPropertiesAccess().getGroup_1_0(), "rule__FormFieldProperties__Group_1_0__0");
					put(grammarAccess.getFormFieldPropertiesAccess().getGroup_1_1(), "rule__FormFieldProperties__Group_1_1__0");
					put(grammarAccess.getFormFieldPropertiesAccess().getGroup_1_2(), "rule__FormFieldProperties__Group_1_2__0");
					put(grammarAccess.getFormFieldPropertiesAccess().getGroup_1_3(), "rule__FormFieldProperties__Group_1_3__0");
					...
					put(grammarAccess.getValueFieldPropertiesAccess().getGroup(), "rule__ValueFieldProperties__Group__0");
					put(grammarAccess.getValueFieldPropertiesAccess().getGroup_1_1(), "rule__ValueFieldProperties__Group_1_1__0");
					...
					put(grammarAccess.getXMemberFeatureCallAccess().getGroup_1_1_3_1(), "rule__XMemberFeatureCall__Group_1_1_3_1__0");
					...
					put(grammarAccess.getXFeatureCallAccess().getGroup_4_1(), "rule__XFeatureCall__Group_4_1__0");
					...
					put(grammarAccess.getLogicElementAccess().getSourceAssignment_4(), "rule__LogicElement__SourceAssignment_4");
					...
					put(grammarAccess.getFormFieldPropertiesAccess().getTextAssignment_1_0_2(), "rule__FormFieldProperties__TextAssignment_1_0_2");
					put(grammarAccess.getFormFieldPropertiesAccess().getEnabledAssignment_1_1_2(), "rule__FormFieldProperties__EnabledAssignment_1_1_2");
					put(grammarAccess.getFormFieldPropertiesAccess().getVisibleAssignment_1_2_2(), "rule__FormFieldProperties__VisibleAssignment_1_2_2");
					put(grammarAccess.getFormFieldPropertiesAccess().getMasterAssignment_1_3_2(), "rule__FormFieldProperties__MasterAssignment_1_3_2");
					put(grammarAccess.getSequenceBoxElementAccess().getNameAssignment_1(), "rule__SequenceBoxElement__NameAssignment_1");
					put(grammarAccess.getSequenceBoxElementAccess().getFormFieldPropertiesAssignment_2(), "rule__SequenceBoxElement__FormFieldPropertiesAssignment_2");
					...
					put(grammarAccess.getGroupBoxElementAccess().getFormFieldPropertiesAssignment_2(), "rule__GroupBoxElement__FormFieldPropertiesAssignment_2");
					...
					put(grammarAccess.getValueFieldPropertiesAccess().getFormFieldPropertiesAssignment_1_0(), "rule__ValueFieldProperties__FormFieldPropertiesAssignment_1_0");
					put(grammarAccess.getValueFieldPropertiesAccess().getMandatoryAssignment_1_1_2(), "rule__ValueFieldProperties__MandatoryAssignment_1_1_2");
					put(grammarAccess.getStringElementAccess().getNameAssignment_1(), "rule__StringElement__NameAssignment_1");
					put(grammarAccess.getStringElementAccess().getValueFieldPropertiesAssignment_2_0(), "rule__StringElement__ValueFieldPropertiesAssignment_2_0");
					put(grammarAccess.getStringElementAccess().getMaxlenAssignment_2_1_2(), "rule__StringElement__MaxlenAssignment_2_1_2");
					...
					put(grammarAccess.getDoubleElementAccess().getValueFieldPropertiesAssignment_2(), "rule__DoubleElement__ValueFieldPropertiesAssignment_2");
					...
					put(grammarAccess.getLongElementAccess().getValueFieldPropertiesAssignment_2(), "rule__LongElement__ValueFieldPropertiesAssignment_2");
					...
					put(grammarAccess.getDateElementAccess().getValueFieldPropertiesAssignment_2(), "rule__DateElement__ValueFieldPropertiesAssignment_2");
					...
					put(grammarAccess.getSmartfieldElementAccess().getValueFieldPropertiesAssignment_2_0(), "rule__SmartfieldElement__ValueFieldPropertiesAssignment_2_0");
					put(grammarAccess.getSmartfieldElementAccess().getCodeAssignment_2_1_2(), "rule__SmartfieldElement__CodeAssignment_2_1_2");
					put(grammarAccess.getSmartfieldElementAccess().getValueTypeAssignment_2_2_2(), "rule__SmartfieldElement__ValueTypeAssignment_2_2_2");
					put(grammarAccess.getSmartfieldElementAccess().getLookupAssignment_2_3_2(), "rule__SmartfieldElement__LookupAssignment_2_3_2");
					...
					put(grammarAccess.getCustomFieldElementAccess().getFormFieldPropertiesAssignment_5(), "rule__CustomFieldElement__FormFieldPropertiesAssignment_5");
					...
					put(grammarAccess.getXMemberFeatureCallAccess().getMemberCallArgumentsAssignment_1_1_3_1_1_1(), "rule__XMemberFeatureCall__MemberCallArgumentsAssignment_1_1_3_1_1_1");
					...
					put(grammarAccess.getXFeatureCallAccess().getFeatureCallArgumentsAssignment_4_1_1_1(), "rule__XFeatureCall__FeatureCallArgumentsAssignment_4_1_1_1");
					...
					put(grammarAccess.getFormFieldPropertiesAccess().getUnorderedGroup_1(), "rule__FormFieldProperties__UnorderedGroup_1");
					put(grammarAccess.getValueFieldPropertiesAccess().getUnorderedGroup_1(), "rule__ValueFieldProperties__UnorderedGroup_1");
