		...
		if (nameMappings == null) {
			nameMappings = new HashMap<AbstractElement, String>() {
				private static final long serialVersionUID = 1L;
				{
					...
					put(grammarAccess.getRunAtTypeAccess().getAlternatives(), "rule__RunAtType__Alternatives");
					put(grammarAccess.getLookupElementAccess().getAlternatives_3(), "rule__LookupElement__Alternatives_3");
					...
					put(grammarAccess.getLogicTypeAccess().getAlternatives(), "rule__LogicType__Alternatives");
					...
					put(grammarAccess.getJavaCodeElementAccess().getGroup(), "rule__JavaCodeElement__Group__0");
					put(grammarAccess.getLogicElementAccess().getGroup(), "rule__LogicElement__Group__0");
					put(grammarAccess.getLogicElementAccess().getGroup_1_0(), "rule__LogicElement__Group_1_0__0");
					put(grammarAccess.getLogicElementAccess().getGroup_1_1(), "rule__LogicElement__Group_1_1__0");
					put(grammarAccess.getLogicElementAccess().getGroup_1_2(), "rule__LogicElement__Group_1_2__0");
					...
					put(grammarAccess.getControlElementRuleAccess().getGroup(), "rule__ControlElementRule__Group__0");
					put(grammarAccess.getControlElementRuleAccess().getGroup_1_0(), "rule__ControlElementRule__Group_1_0__0");
					put(grammarAccess.getControlElementRuleAccess().getGroup_1_1(), "rule__ControlElementRule__Group_1_1__0");
					put(grammarAccess.getControlElementRuleAccess().getGroup_1_2(), "rule__ControlElementRule__Group_1_2__0");
					put(grammarAccess.getCompositeElementRuleAccess().getGroup(), "rule__CompositeElementRule__Group__0");
					...
					put(grammarAccess.getModelAccess().getCodesAssignment_2_0(), "rule__Model__CodesAssignment_2_0");
					put(grammarAccess.getModelAccess().getTranslationsAssignment_2_1(), "rule__Model__TranslationsAssignment_2_1");
					put(grammarAccess.getModelAccess().getCodesAssignment_2_2(), "rule__Model__CodesAssignment_2_2");
					put(grammarAccess.getModelAccess().getLookupsAssignment_2_3(), "rule__Model__LookupsAssignment_2_3");
					...
					put(grammarAccess.getJavaCodeElementAccess().getNameAssignment_1(), "rule__JavaCodeElement__NameAssignment_1");
					put(grammarAccess.getJavaCodeElementAccess().getRunatAssignment_4(), "rule__JavaCodeElement__RunatAssignment_4");
					put(grammarAccess.getJavaCodeElementAccess().getSourceAssignment_5(), "rule__JavaCodeElement__SourceAssignment_5");
					put(grammarAccess.getLogicElementAccess().getEventAssignment_1_0_2(), "rule__LogicElement__EventAssignment_1_0_2");
					put(grammarAccess.getLogicElementAccess().getRunatAssignment_1_1_2(), "rule__LogicElement__RunatAssignment_1_1_2");
					put(grammarAccess.getLogicElementAccess().getExecAssignment_1_2_2(), "rule__LogicElement__ExecAssignment_1_2_2");
					put(grammarAccess.getLogicElementAccess().getSourceAssignment_2(), "rule__LogicElement__SourceAssignment_2");
					...
					put(grammarAccess.getLookupElementAccess().getLogicAssignment_3_0(), "rule__LookupElement__LogicAssignment_3_0");
					put(grammarAccess.getLookupElementAccess().getJavacodeAssignment_3_1(), "rule__LookupElement__JavacodeAssignment_3_1");
					...
					put(grammarAccess.getControlElementRuleAccess().getTextAssignment_1_0_2(), "rule__ControlElementRule__TextAssignment_1_0_2");
					put(grammarAccess.getControlElementRuleAccess().getEnabledAssignment_1_1_2(), "rule__ControlElementRule__EnabledAssignment_1_1_2");
					put(grammarAccess.getControlElementRuleAccess().getVisibleAssignment_1_2_2(), "rule__ControlElementRule__VisibleAssignment_1_2_2");
					put(grammarAccess.getCompositeElementRuleAccess().getRuleAssignment_0(), "rule__CompositeElementRule__RuleAssignment_0");
					put(grammarAccess.getCompositeElementRuleAccess().getLogicAssignment_2_0(), "rule__CompositeElementRule__LogicAssignment_2_0");
					put(grammarAccess.getCompositeElementRuleAccess().getChildreAssignment_2_1(), "rule__CompositeElementRule__ChildreAssignment_2_1");
					put(grammarAccess.getStringElementAccess().getNameAssignment_1(), "rule__StringElement__NameAssignment_1");
					put(grammarAccess.getStringElementAccess().getFieldRuleAssignment_2_0(), "rule__StringElement__FieldRuleAssignment_2_0");
					put(grammarAccess.getStringElementAccess().getMandatoryAssignment_2_1_2(), "rule__StringElement__MandatoryAssignment_2_1_2");
					put(grammarAccess.getStringElementAccess().getMasterAssignment_2_2_2(), "rule__StringElement__MasterAssignment_2_2_2");
					...
					put(grammarAccess.getDoubleElementAccess().getFieldRuleAssignment_2_0(), "rule__DoubleElement__FieldRuleAssignment_2_0");
					put(grammarAccess.getDoubleElementAccess().getMandatoryAssignment_2_1_2(), "rule__DoubleElement__MandatoryAssignment_2_1_2");
					...
					put(grammarAccess.getLongElementAccess().getFieldRuleAssignment_2_0(), "rule__LongElement__FieldRuleAssignment_2_0");
					put(grammarAccess.getLongElementAccess().getMandatoryAssignment_2_1_2(), "rule__LongElement__MandatoryAssignment_2_1_2");
					...
					put(grammarAccess.getLogicElementAccess().getUnorderedGroup_1(), "rule__LogicElement__UnorderedGroup_1");
					put(grammarAccess.getFormElementAccess().getUnorderedGroup_2(), "rule__FormElement__UnorderedGroup_2");
					put(grammarAccess.getControlElementRuleAccess().getUnorderedGroup_1(), "rule__ControlElementRule__UnorderedGroup_1");
