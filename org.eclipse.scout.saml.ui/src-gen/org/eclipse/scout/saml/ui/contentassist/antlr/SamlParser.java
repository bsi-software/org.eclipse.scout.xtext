		...
		if (nameMappings == null) {
			nameMappings = new HashMap<AbstractElement, String>() {
				private static final long serialVersionUID = 1L;
				{
					...
					put(grammarAccess.getStringElementAccess().getGridHeightAssignment_2_7_2(), "rule__StringElement__GridHeightAssignment_2_7_2");
					put(grammarAccess.getStringElementAccess().getGridWidthAssignment_2_8_2(), "rule__StringElement__GridWidthAssignment_2_8_2");
					put(grammarAccess.getStringElementAccess().getWidthInPixelsAssignment_2_9_2(), "rule__StringElement__WidthInPixelsAssignment_2_9_2");
					put(grammarAccess.getStringElementAccess().getHorizontalAlignAssignment_2_10_2(), "rule__StringElement__HorizontalAlignAssignment_2_10_2");
					put(grammarAccess.getStringElementAccess().getSuperTypeAssignment_2_11_2(), "rule__StringElement__SuperTypeAssignment_2_11_2");
					put(grammarAccess.getStringElementAccess().getRegexValidationAssignment_2_12_2(), "rule__StringElement__RegexValidationAssignment_2_12_2");
					...
					put(grammarAccess.getSmartfieldElementAccess().getGridWidthAssignment_2_9_2(), "rule__SmartfieldElement__GridWidthAssignment_2_9_2");
					put(grammarAccess.getSmartfieldElementAccess().getWidthInPixelsAssignment_2_10_2(), "rule__SmartfieldElement__WidthInPixelsAssignment_2_10_2");
					put(grammarAccess.getSmartfieldElementAccess().getSuperTypeAssignment_2_11_2(), "rule__SmartfieldElement__SuperTypeAssignment_2_11_2");
