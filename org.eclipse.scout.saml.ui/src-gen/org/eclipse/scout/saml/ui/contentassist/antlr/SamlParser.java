		...
		if (nameMappings == null) {
			nameMappings = new HashMap<AbstractElement, String>() {
				private static final long serialVersionUID = 1L;
				{
					...
					put(grammarAccess.getFormElementAccess().getTextAssignment_2_2_2(), "rule__FormElement__TextAssignment_2_2_2");
					...
					put(grammarAccess.getSequenceBoxElementAccess().getMasterAssignment_2_3_2(), "rule__SequenceBoxElement__MasterAssignment_2_3_2");
					...
					put(grammarAccess.getStringElementAccess().getMasterAssignment_2_3_2(), "rule__StringElement__MasterAssignment_2_3_2");
					put(grammarAccess.getStringElementAccess().getMandatoryAssignment_2_4_2(), "rule__StringElement__MandatoryAssignment_2_4_2");
					put(grammarAccess.getStringElementAccess().getMaxlenAssignment_2_5_2(), "rule__StringElement__MaxlenAssignment_2_5_2");
					...
					put(grammarAccess.getDoubleElementAccess().getMasterAssignment_2_3_2(), "rule__DoubleElement__MasterAssignment_2_3_2");
					put(grammarAccess.getDoubleElementAccess().getMandatoryAssignment_2_4_2(), "rule__DoubleElement__MandatoryAssignment_2_4_2");
					...
					put(grammarAccess.getLongElementAccess().getMasterAssignment_2_3_2(), "rule__LongElement__MasterAssignment_2_3_2");
					put(grammarAccess.getLongElementAccess().getMandatoryAssignment_2_4_2(), "rule__LongElement__MandatoryAssignment_2_4_2");
					...
					put(grammarAccess.getDateElementAccess().getMasterAssignment_2_3_2(), "rule__DateElement__MasterAssignment_2_3_2");
					put(grammarAccess.getDateElementAccess().getMandatoryAssignment_2_4_2(), "rule__DateElement__MandatoryAssignment_2_4_2");
					...
					put(grammarAccess.getSmartfieldElementAccess().getMasterAssignment_2_3_2(), "rule__SmartfieldElement__MasterAssignment_2_3_2");
					put(grammarAccess.getSmartfieldElementAccess().getMandatoryAssignment_2_4_2(), "rule__SmartfieldElement__MandatoryAssignment_2_4_2");
					put(grammarAccess.getSmartfieldElementAccess().getCodeAssignment_2_5_2(), "rule__SmartfieldElement__CodeAssignment_2_5_2");
					put(grammarAccess.getSmartfieldElementAccess().getValueTypeAssignment_2_6_2(), "rule__SmartfieldElement__ValueTypeAssignment_2_6_2");
					put(grammarAccess.getSmartfieldElementAccess().getLookupAssignment_2_7_2(), "rule__SmartfieldElement__LookupAssignment_2_7_2");
					...
					put(grammarAccess.getCustomFieldElementAccess().getMasterAssignment_5_3_2(), "rule__CustomFieldElement__MasterAssignment_5_3_2");
