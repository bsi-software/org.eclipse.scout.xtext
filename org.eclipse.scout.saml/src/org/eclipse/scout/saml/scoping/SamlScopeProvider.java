...
public class SamlScopeProvider extends XbaseScopeProvider {
  ...
  public IScope getScope(EObject context, EReference reference) {
    if (reference == SamlPackage.Literals.VALUE_FIELD_ELEMENT__MASTER) {
      if (context instanceof ValueFieldElement) {
        ValueFieldElement formField = (ValueFieldElement) context;
