 ...
 *   <li>{@link org.eclipse.scout.saml.saml.impl.LookupElementImpl#getJavacode <em>Javacode</em>}</li>
 * </ul>
 * </p>
 *
 * @generated
...
public class LookupElementImpl extends MinimalEObjectImpl.Container implements LookupElement
{
  ...
  /**
   * The cached value of the '{@link #getJavacode() <em>Javacode</em>}' containment reference list.
   * <!-- begin-user-doc -->
   * <!-- end-user-doc -->
   * @see #getJavacode()
   * @generated
   * @ordered
   */
  protected EList<JavaCodeElement> javacode;
   ...
   * @generated
   */
  public EList<JavaCodeElement> getJavacode()
  {
    if (javacode == null)
    {
      javacode = new EObjectContainmentEList<JavaCodeElement>(JavaCodeElement.class, this, SamlPackage.LOOKUP_ELEMENT__JAVACODE);
    }
    return javacode;
  }
  ...
  public NotificationChain eInverseRemove(InternalEObject otherEnd, int featureID, NotificationChain msgs)
  {
    switch (featureID)
    {
      ...
      case SamlPackage.LOOKUP_ELEMENT__JAVACODE:
        return ((InternalEList<?>)getJavacode()).basicRemove(otherEnd, msgs);
    }
  ...
  public void eSet(int featureID, Object newValue)
  {
    switch (featureID)
    {
      ...
      case SamlPackage.LOOKUP_ELEMENT__JAVACODE:
        getJavacode().clear();
        getJavacode().addAll((Collection<? extends JavaCodeElement>)newValue);
        return;
    }
  ...
  public boolean eIsSet(int featureID)
  {
    switch (featureID)
    {
      ...
      case SamlPackage.LOOKUP_ELEMENT__JAVACODE:
        return javacode != null && !javacode.isEmpty();
    }
