 ...
 * <ul>
 *   <li>{@link org.eclipse.scout.saml.saml.impl.GenericValueFieldElementImpl#getCode <em>Code</em>}</li>
 *   <li>{@link org.eclipse.scout.saml.saml.impl.GenericValueFieldElementImpl#getValueType <em>Value Type</em>}</li>
 *   <li>{@link org.eclipse.scout.saml.saml.impl.GenericValueFieldElementImpl#getLookup <em>Lookup</em>}</li>
 * </ul>
 * </p>
 *
 * @generated
...
public class GenericValueFieldElementImpl extends ValueFieldElementImpl implements GenericValueFieldElement
{
    ...
    if (code != null && code.eIsProxy())
    {
      ...
      if (code != oldCode)
      {
        if (eNotificationRequired())
          eNotify(new ENotificationImpl(this, Notification.RESOLVE, SamlPackage.GENERIC_VALUE_FIELD_ELEMENT__CODE, oldCode, code));
      }
    }
    return code;
  }
  ...
  public void setCode(CodeElement newCode)
  {
    ...
    code = newCode;
    if (eNotificationRequired())
      eNotify(new ENotificationImpl(this, Notification.SET, SamlPackage.GENERIC_VALUE_FIELD_ELEMENT__CODE, oldCode, code));
  }
  ...
  public LookupElement getLookup()
  {
    if (lookup != null && lookup.eIsProxy())
    {
      ...
      {
        if (eNotificationRequired())
          eNotify(new ENotificationImpl(this, Notification.RESOLVE, SamlPackage.GENERIC_VALUE_FIELD_ELEMENT__LOOKUP, oldLookup, lookup));
      }
    }
    return lookup;
  }
  ...
  public void setLookup(LookupElement newLookup)
  {
    ...
    lookup = newLookup;
    if (eNotificationRequired())
      eNotify(new ENotificationImpl(this, Notification.SET, SamlPackage.GENERIC_VALUE_FIELD_ELEMENT__LOOKUP, oldLookup, lookup));
  }
  ...
  public Object eGet(int featureID, boolean resolve, boolean coreType)
  {
    switch (featureID)
    {
      case SamlPackage.GENERIC_VALUE_FIELD_ELEMENT__CODE:
        if (resolve) return getCode();
        return basicGetCode();
      case SamlPackage.GENERIC_VALUE_FIELD_ELEMENT__VALUE_TYPE:
        return getValueType();
      case SamlPackage.GENERIC_VALUE_FIELD_ELEMENT__LOOKUP:
