 ...
 * <ul>
 *   <li>{@link org.eclipse.scout.saml.saml.impl.DoubleElementImpl#getMandatory <em>Mandatory</em>}</li>
 * </ul>
 * </p>
 *
 * @generated
...
public class DoubleElementImpl extends ValueFieldElementImpl implements DoubleElement
{
  ...
  public void setMandatory(String newMandatory)
  {
    ...
    if (eNotificationRequired())
      eNotify(new ENotificationImpl(this, Notification.SET, SamlPackage.DOUBLE_ELEMENT__MANDATORY, oldMandatory, mandatory));
  }
  ...
  public Object eGet(int featureID, boolean resolve, boolean coreType)
  {
    switch (featureID)
    {
      case SamlPackage.DOUBLE_ELEMENT__MANDATORY:
        return getMandatory();
    }
