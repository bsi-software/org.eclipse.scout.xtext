 ...
 * @generated
 */
public interface TranslationElement extends RootElement
{
  /**
   * Returns the value of the '<em><b>Translations</b></em>' containment reference list.
   * The list contents are of type {@link org.eclipse.scout.saml.saml.TranslationAttribute}.
   * <!-- begin-user-doc -->
   * <p>
   ...
   * @generated
   */
  EList<TranslationAttribute> getTranslations();
