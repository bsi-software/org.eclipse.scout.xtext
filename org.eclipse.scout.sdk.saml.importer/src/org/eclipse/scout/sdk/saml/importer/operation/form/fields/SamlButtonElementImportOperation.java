...
/**
 * <h3>{@link SamlButtonElementImportOperation}</h3> ...
 * 
 * @author mvi
 * @since 3.8.0 26.09.2012
 */
public class SamlButtonElementImportOperation extends AbstractSamlFormFieldElementOperation {
  ...
  public final void run() throws CoreException, IllegalArgumentException {
    ...
    MenuElementImportOperation.processMenus(getButtonElement().getMenus(), createdField, getSamlContext());
  }
